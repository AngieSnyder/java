...
public class ShowSelectorApp {
	...
	public static void main(String[] args) {
		...
		//what way do you want to search
		String searchCriteria = Console.getString("Search by (g)enre, (l)ength, or (n)etwork?");
		String searchValue = "";
		if (searchCriteria.equalsIgnoreCase("g")) {
			...
			searchValue = Console.getString("Hulu, ABC, CBS, Netflix?");
		}
